...
class Urposition():
    ...
    # ========================================================
    # note that I have changed this in 0728, added reading joint vel, and the sequence was changed to normal 123456
    def callback(self, msg):
        self.read_pos_from_ur_joint( msg )
        self.read_vel_from_ur_joint(msg)
    ...
    def read_pos_from_ur_joint(self, msg):
        ...
        self.now_ur_pos[0],self.now_ur_pos[2] = self.now_ur_pos[2],self.now_ur_pos[0]
        # print("pos_msg:", pos_msg)
        # ur_pose = [ pos_msg.x , pos_msg.y, pos_msg.z, quaternion_msg.x, quaternion_msg.y, quaternion_msg.w  ]
        # return pos_msg
        # print(self.now_ur_pos)

    # ========================================================
    def read_vel_from_ur_joint(self, msg):
        self.now_joint_vel = list( msg.velocity )
        self.now_joint_vel[0],self.now_joint_vel[2] = self.now_joint_vel[2],self.now_joint_vel[0]
...
def main():
    ...
    while not rospy.is_shutdown():
        print(ur_info_reader.now_ur_pos)
        pass
