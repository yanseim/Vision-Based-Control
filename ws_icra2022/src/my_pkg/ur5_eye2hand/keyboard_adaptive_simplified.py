...
def main():
    ...
    dir = '/keyboard_adaptive_simplified/'
    ...
    while not rospy.is_shutdown():
        ...
        if flag_initialized==0:# 先回到初始位置，movej的t参数是不需要的，这里给0 ==================
            ...
            theta_z =[ 0.04004957, -0.99886772,  0.0256769,   0.88164686]
            ...
            #                                 [-5.77950645e-03, -9.99957496e-01, -7.18357448e-03]])# 之前的错误的
